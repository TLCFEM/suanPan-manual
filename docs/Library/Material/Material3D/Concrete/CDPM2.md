...
4. For detailed explanations of parameters, please refer to Reference [1](https://doi.org/10.1016/j.ijsolstr.2013.07.008).
5. The default `CDPM2` uses isotropic damage.
6. The token `CDPM2ANISO` uses anisotropic damage.
7. If damage is activated, both tension and compression use exponential damage model, the degradation is controlled by parameters [14] and [15]. The characteristic length can be accounted for by modifying [14].
...
# [3] double, poissons ratio, default: .3
# [4] double, tension strength (positive), default: 3.
# [5] double, compression strength (positive), default: 10.
# [6] double, q_h0, initial hardening factor, default: .3
# [7] double, h_p hardening ratio, default: .01
# [8] double, d_f, default: .85
# [9] double, a_h, hardening related parameter, default: .08
# [10] double, b_h, hardening related parameter, default: .003
# [11] double, c_h, hardening related parameter, default: 2.
# [12] double, d_h, hardening related parameter, default: 1E-6
# [13] double, a_s, ductility related parameter, default: 5.
